...
// module.exports.EditorUi = EditorUi;
...
EditorUi.prototype.initCanvas = function () {
  ...
  graph.getPagePadding = function () {
    ...
    // return new mxPoint(Math.max(0, Math.round((graph.container.offsetWidth - 34) / graph.view.scale))/3,
    //   Math.max(0, Math.round((graph.container.offsetHeight - 34) / graph.view.scale))/3);
  };
      ...
      graph.sizeDidChange = function () {
        ...
        if (this.container != null && mxUtils.hasScrollbars(this.container)) {
          ...
          if (!this.autoTranslate && (this.view.translate.x != dx || this.view.translate.y != dy)) {
            ...
            // graph.container.scrollLeft +="250px";
            // graph.container.scrollTop +="250px";
...
EditorUi.prototype.createUi = function () {
  ...
  // this.scadaTitle = (this.editor.chromeless) ? null : document.createElement("div");
  // this.scadaTitle.id = 'gescadaTitle';
  // this.scadaTitle.setAttribute("id", 'gescadaTitle');
  // this.scadaTitle.setAttribute("class", 'geScadaTitleClass');

  // if (this.menubar != null) {
  //   this.menubarContainer.appendChild(this.scadaTitle);
